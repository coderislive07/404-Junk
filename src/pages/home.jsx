      ...
      <section id="pricing" className="py-20 bg-gray-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="text-center mb-16">
          ...
          {/* Service Selection */}
          <div className="mb-12">
            <h3 className="text-2xl font-bold mb-6 text-center">Choose Your Service Type</h3>
          ...
          {selectedService && (
            <div className="mb-12">
              <h3 className="text-2xl font-bold mb-6 text-center">Estimated Weight Range</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {weightOptions.map((option) => (
                  ...
                  >
                    <div className="text-lg font-bold">{option.range}</div>
          ...
          {/* Estimate Display */}
          {showEstimate && selectedWeight && (
            <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-8 text-center">
              <h3 className="text-3xl font-bold mb-4">
                Starting at ${typeof selectedWeight.price === "number" ? selectedWeight.price : "509"}
              </h3>
              <p className="text-gray-400 mb-6">
                This estimate includes our pull up (curb side) pickup base rate of $181, which covers the first 200lbs.
                Any additional junk is calculated at $0.41/lb
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <div className="text-gray-400">
                  <p>Discounts may apply for larger weights. Call for free quote.</p>
                  <p className="font-bold text-green-400">604-505-5865</p>
                </div>
              </div>
            </div>
          )}
